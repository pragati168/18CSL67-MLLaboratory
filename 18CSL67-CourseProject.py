...
pytesseract.pytesseract.tesseract_cmd = '../aiml/Tesseract-OCR/tesseract.exe'
...
def detect():
    ...
    cv2.drawContours(tempImg, contours, -1, (0, 255, 0), 4)
    cv2.imshow("Dectected Objects in  Image",tempImg)
    rect = []
